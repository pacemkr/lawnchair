...
Lawnchair.prototype = {
	...
	get:function(key, onSuccess, onFailure) {
		    onSuccess = onSuccess || this.doNothing;
		    onFailure = onFailure || this.doNothing;
		    this.adaptor.get(key, onSuccess, onFailure)
	    },

	// Returns whether a key exists to a callback.
	exists:function(onSuccess, onFailure) {
		       onSuccess = onSuccess || this.doNothing;
		       onFailure = onFailure || this.doNothing;
		       this.adaptor.exists(onSuccess, onFailure)
	       },
	...
	all:function(onSuccess, onFailure) {
		    onSuccess = onSuccess || this.doNothing;
		    onFailure = onFailure || this.doNothing;
		    this.adaptor.all(onSuccess, onFailure)
	    },
	...
	remove:function(keyOrObj, onSuccess, onFailure) {
		       onSuccess = onSuccess || this.doNothing;
		       onFailure = onFailure || this.doNothing;
		       this.adaptor.remove(keyOrObj, onSuccess, onFailure)
	       },
	...
	nuke:function(onSuccess, onFailure) {
		     onSuccess = onSuccess || this.doNothing;
		     onFailure = onFailure || this.doNothing;
		     this.adaptor.nuke(onSuccess, onFailure);
		     return this;
	     },
	...
	paged:function(page, onSuccess, onFailure) {
		      onSuccess = onSuccess || this.doNothing;
		      onFailure = onFailure || this.doNothing;
		      this.adaptor.paged(page, onSuccess, onFailure)
	      },
